...
static void addRunLoopObserver() {
    ...
    dispatch_once(&onceToken, ^{
		...
		CFRunLoopObserverRef observer = CFRunLoopObserverCreate(CFAllocatorGetDefault(), kCFRunLoopAfterWaiting|kCFRunLoopExit, true, 0xFFFFFF, runLoopObserverCallBack, NULL);
